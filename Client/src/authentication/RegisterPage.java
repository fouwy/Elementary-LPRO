...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        Font userLabelFont = this.$$$getFont$$$(null, Font.BOLD, -1, userLabel.getFont());
        if (userLabelFont != null) userLabel.setFont(userLabelFont);
        userLabel.setForeground(new Color(-13332258));
        ...
        pwdLabel = new JLabel();
        Font pwdLabelFont = this.$$$getFont$$$(null, Font.BOLD, -1, pwdLabel.getFont());
        if (pwdLabelFont != null) pwdLabel.setFont(pwdLabelFont);
        pwdLabel.setForeground(new Color(-13332258));
        ...
        emailLabel.setForeground(new Color(-13332258));
        ...
        Font repeatPwdLabelFont = this.$$$getFont$$$(null, Font.BOLD, -1, repeatPwdLabel.getFont());
        if (repeatPwdLabelFont != null) repeatPwdLabel.setFont(repeatPwdLabelFont);
        repeatPwdLabel.setForeground(new Color(-13332258));
        ...
        registerButton.setBackground(new Color(-10077786));
        Font registerButtonFont = this.$$$getFont$$$(null, Font.BOLD, 13, registerButton.getFont());
