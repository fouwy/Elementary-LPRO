...
public class DicePanel extends JPanel {
    ...
    DicePanel() {
        ...
        ImageIcon ic1 = new ImageIcon("Client/src/img/dice/1.png");
        ImageIcon ic2 = new ImageIcon("Client/src/img/dice/2.png");
        ImageIcon ic3 = new ImageIcon("Client/src/img/dice/3.png");
        ImageIcon ic4 = new ImageIcon("Client/src/img/dice/4.png");
        ImageIcon ic5 = new ImageIcon("Client/src/img/dice/5.png");
        ImageIcon ic6 = new ImageIcon("Client/src/img/dice/6.png");
