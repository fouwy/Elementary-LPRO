...
public class Panel extends JPanel implements KeyListener/*, ActionListener*/{
	...
	int PALACE_RIGHT = 648; //- character widthm, dx
	...
	Panel(int xpanel, int ypanel, int width, int height, int r, int g, int b){
		...
		backgroundImage = new ImageIcon("map4.png").getImage();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(dx + distance == 3 || dx - distance < 0) {
		...
		if(dy + distance == height || dy - distance < 0){
	...
	public void paint(Graphics g) {
		super.paint(g);
		Graphics2D g2D = (Graphics2D)g;	//cast graphics variable 
